...
evt_file = '/home/paolafer/analysis/petalo/full_ring_depth3cm_pitch4mm_phot_geo_map_{0}_{1}_{2}'.format(start,numb,max_cut)

rpos_file = '/home/paolafer/analysis/r_table_var_thr_4mm.h5'

#base_file = '/Users/paola/PETALO/sim/full_ring_depth3cm_pitch4mm.{0}.pet.h5'
#evt_file = '/Users/paola/PETALO/analysis/full_ring_depth3cm_pitch4mm_phot_reco_ext_{0}_{1}_{2}'.format(start,numb,max_cut)
...
print('Events neglected because no good position reconstruction = {}'.format(evt_no_pos))
print('Events neglected because no charges above threshold = {}'.format(evt_no_energy))
...
np.savez(evt_file, a_reco_r1=a_reco_r1, a_reco_phi1=a_reco_phi1, a_reco_z1=a_reco_z1, a_reco_r2=a_reco_r2, a_reco_phi2=a_reco_phi2, a_reco_z2=a_reco_z2, a_photo_response1_int=a_photo_response1_int, a_photo_response2_int=a_photo_response2_int, a_photo_response1_ext=a_photo_response1_ext, a_photo_response2_ext=a_photo_response2_ext, a_photo_response1=a_photo_response1, a_photo_response2=a_photo_response2, a_events=a_events)
